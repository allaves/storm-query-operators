 ...
 * Extended from SingleJoinBolt
 * https://github.com/nathanmarz/storm-starter/blob/master/src/jvm/storm/starter/bolt/SingleJoinBolt.java
 */
public class ExtendedSingleJoinBolt extends BaseRichBolt {
	
	  private static final long serialVersionUID = -5534110731713616458L;
	  OutputCollector _collector;
	  Fields _idFields;
	  Fields _outFields;
	  int _numSources;
	  //TimeCacheMap<List<Object>, Map<GlobalStreamId, Tuple>> _pending;  // Deprecated. Replaced by RotatingMap.
	  RotatingMap<List<Object>, Map<GlobalStreamId, Tuple>> _pending;
	  Map<String, GlobalStreamId> _fieldLocations;
	
	  public ExtendedSingleJoinBolt(Fields outFields) {
